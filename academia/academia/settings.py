...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', '0.0.0.0', '192.168.43.170']
...
LANGUAGE_CODE = 'es-cl'  # Opcional: pone los mensajes en español de Chile

TIME_ZONE = 'America/Santiago'

USE_I18N = True

USE_TZ = True  # Mantén esto en True para manejar cambios de horario de verano automáticamente
